...
class SVI_GroupAdherence_Model_Adherence
    extends Mage_Rule_Model_Abstract
{
    ...
    {
        return Mage::getModel('svi_groupAdherence/rules_combinations');
    }
    ...
    {
        Mage::getModel('svi_groupAdherence/adherence')
            ->getCollection()
    ...
    public function applyRule($id)
    {
        ...
        Mage::getResourceModel('svi_groupAdherence/adherence')->updateRuleCustomerData($rule);
