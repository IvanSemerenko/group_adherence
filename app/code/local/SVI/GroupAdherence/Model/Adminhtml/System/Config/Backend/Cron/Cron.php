...
class SVI_GroupAdherence_Model_Adminhtml_System_Config_Backend_Cron_Cron
    extends Mage_Core_Model_Config_Data
{
    const CRON_STRING_PATH  = 'crontab/jobs/svi_groupAdherence/schedule/cron_expr';
    const CRON_MODEL_PATH   = 'crontab/jobs/svi_groupAdherence/run/model';
